...
class PendaftaranPemesananController extends Controller
{
    public function index()
    {
        ...
        return view('dashboard.staf.halaman.penjualan_perumahan.pendaftaran_pesanan.index', [
    ...
    public function create()
    {
        ...
        return view('dashboard.staf.halaman.penjualan_perumahan.pendaftaran_pesanan.create', [
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/staf/pendaftaran-pemesanan');
    }

    public function edit(PendaftaranPemesanan $pendaftaranPemesanan)
    {
        return view('dashboard.staf.halaman.penjualan_perumahan.pendaftaran_pesanan.edit', [
