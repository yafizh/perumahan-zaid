...
class PembayaranUangMukaController extends Controller
{
    public function index()
    {
        ...
        return view('dashboard.admin.halaman.penjualan_perumahan.pembayaran_uang_muka.index', [
    ...
    public function create()
    {
        ...
        return view('dashboard.admin.halaman.penjualan_perumahan.pembayaran_uang_muka.create', [
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/admin/pembayaran-uang-muka');
    }

    public function edit(PembayaranUangMuka $pembayaranUangMuka)
    {
        return view('dashboard.admin.halaman.penjualan_perumahan.pembayaran_uang_muka.edit', [
