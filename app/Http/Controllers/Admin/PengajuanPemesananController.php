...
class PengajuanPemesananController extends Controller
{
    public function index()
    {
        ...
        return view('dashboard.admin.halaman.penjualan_perumahan.pendaftaran_pesanan_online.index', [
    ...
    {
        return view('dashboard.admin.halaman.penjualan_perumahan.pendaftaran_pesanan_online.show', [
    ...
    public function terima(PendaftaranPemesananOnline $pengajuanPemesanan)
    {
        ...
        return redirect('/admin/pengajuan-pemesanan/' . $pengajuanPemesanan->id);
    }
