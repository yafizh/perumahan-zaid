...
use App\Models\DetailRiwayatPembayaranRumahPelanggan;
use App\Models\Pembayaran;
use App\Models\RiwayatPembayaranRumahPelanggan;
...
class PembayaranRumahController extends Controller
{
    public function index()
    {
        ...
        return view('dashboard.admin.halaman.penjualan_perumahan.pembayaran_rumah.index', [
    ...
    {
        return view('dashboard.admin.halaman.penjualan_perumahan.pembayaran_rumah.show', [
    ...
    public function terima(DetailPembayaran $detailPembayaran)
    {
        ...
        return redirect('/admin/pembayaran-rumah/' . $detailPembayaran->id);
    }
