...
class LaporanController extends Controller
{
    public function rumah()
    {
        ...
        return view('dashboard.direktur.halaman.laporan.rumah', [
    ...
    public function penjualanRumah()
    {
        ...
        $href = "/direktur/cetak/penjualan-rumah?";
        ...
        return view('dashboard.direktur.halaman.laporan.penjualan_rumah', [
            'blok' => BlokPerumahan::orderBy('urutan')->get(),
    ...
    public function pemesananRumah()
    {
        ...
        $href = "/direktur/cetak/pemesanan-rumah?";
        ...
        return view('dashboard.direktur.halaman.laporan.pemesanan_rumah', [
            'blok' => BlokPerumahan::orderBy('urutan')->get(),
    ...
    public function keluhanPelanggan()
    {
        ...
        $href = "/direktur/cetak/keluhan-pelanggan?";
        ...
        return view('dashboard.direktur.halaman.laporan.keluhan_pelanggan', [
    ...
    public function progresPembangunanRumah()
    {
        ...
        $href = "/direktur/cetak/progres-pembangunan-rumah?";
        ...
        return view('dashboard.direktur.halaman.laporan.progres_pembangunan_rumah', [
            'blok' => BlokPerumahan::orderBy('urutan')->get(),
    ...
    public function promo()
    {
        ...
        return view('dashboard.direktur.halaman.laporan.promo', [
            'promo' => $promo,
            'href' => $href
        ]);
    }
    ...
    public function grafikPenjualan()
    {
        if (request()->get('kuartal') && request()->get('tahun')) {
            ...
            $href = "/direktur/cetak/grafik-penjualan?kuartal=" . request()->get('kuartal') . "&tahun=" . request()->get('tahun');
            ...
            return view('dashboard.direktur.halaman.laporan.grafik_penjualan', [
                'chart' => $chart,
                'href' => $href
            ]);
        }
    ...
    public function grafikPemesanan()
    {
        if (request()->get('kuartal') && request()->get('tahun')) {
            ...
            $href = "/direktur/cetak/grafik-pemesanan?kuartal=" . request()->get('kuartal') . "&tahun=" . request()->get('tahun');
            ...
            return view('dashboard.direktur.halaman.laporan.grafik_pemesanan', [
                'chart' => $chart,
                'href' => $href
            ]);
        }
    ...
    public function keuanganPembayaranRumah()
    {
        ...
        $href = "/direktur/cetak/keuangan-pembayaran-rumah?";
        ...
        return view('dashboard.direktur.halaman.laporan.keuangan_pembayaran_rumah', [
    ...
    public function rekapTagihanPembayaranRumah()
    {
        ...
        $href = "/direktur/cetak/rekap-tagihan-pembayaran-rumah?";
        ...
        return view('dashboard.direktur.halaman.laporan.rekap_tagihan_pembayaran_rumah', [
