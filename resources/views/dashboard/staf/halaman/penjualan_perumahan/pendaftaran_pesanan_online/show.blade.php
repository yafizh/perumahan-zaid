...
@section('content')
    <div class="container pt-5">
        <x-header-dashboard>
            ...
            <x-slot:buttons>
                <a href="/staf/pengajuan-pemesanan" class="btn btn-secondary w-100 mb-3">Kembali</a>
            </x-slot:buttons>
        </x-header-dashboard>
        <hr>
            ...
            <div class="col-12 col-md-6">
                ...
                @if ($pengajuanPemesanan->status == 1)
                    <div class="mb-3 d-flex justify-content-end gap-2">
                        <form action="/staf/pengajuan-pemesanan/{{ $pengajuanPemesanan->id }}/tolak" method="POST">
                            @csrf
                            @method('PATCH')
                            <button type="submit" class="btn btn-danger">Tolak</button>
                        </form>
                        <form action="/staf/pengajuan-pemesanan/{{ $pengajuanPemesanan->id }}/terima" method="POST">
                            @csrf
                            @method('PATCH')
