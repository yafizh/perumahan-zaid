...
@section('content')
    <div class="container pt-3">
        <div class="d-flex justify-content-between align-items-center">
            <h4>Data Penjualan Penjualan</h4>
            <a href="/staf/pembayaran-uang-muka/create" class="btn btn-primary">Tambah</a>
        </div>
        <hr>
        <main class="mb-3">
                        ...
                        @foreach ($pembayaran_uang_muka as $item)
                            <tr>
                                ...
                                <td class="d-flex gap-2">
                                    ...
                                    <a href="/staf/pembayaran-uang-muka/{{ $item->id }}/edit"
                                        class="btn btn-warning btn-sm">Edit</a>
                                    <form action="/staf/pembayaran-uang-muka/{{ $item->id }}" method="POST">
                                        @csrf
                                        @method('DELETE')
