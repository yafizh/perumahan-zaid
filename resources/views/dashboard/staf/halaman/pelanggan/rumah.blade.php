    ...
    <div class="container pt-5">
        <x-header-dashboard>
            ...
            <x-slot:buttons>
                ...
                <a href="/staf/pendaftaran-pemesanan/create?id_pelanggan={{ $pelanggan->id }}"
                    class="btn btn-warning w-100 mb-3">Pemesanan</a>
                <a href="/staf/pembayaran-uang-muka/create?id_pelanggan={{ $pelanggan->id }}"
                            ...
                            <div class="col-12 col-md-8 mb-3">
                                ...
                                @if ($item->status == 3)
                                    <div class="d-flex justify-content-end">
                                        <a href="/staf/pembayaran-uang-muka/create?id_pelanggan={{ $pelanggan->id }}&id_rumah={{ $item->rumah->id }}&kredit=true"
                            ...
                            <div class="col-12 col-md-8 mb-3">
                                ...
                                @if ($item->rumah->status_ketersediaan == 2)
                                    <div class="d-flex justify-content-end gap-2">
                                        @if (!$item->pengajuanKredit)
                                            <a href="/staf/pengajuan-kredit/create?id_pelanggan={{ $pelanggan->id }}&id_rumah={{ $item->rumah->id }}"
                                                class="btn btn-info">
                                        ...
                                        @if ($item->pengajuanKredit)
                                            @if ($item->pengajuanKredit->status == 1)
                                                <a href="/staf/pembayaran-uang-muka/create?id_pelanggan={{ $pelanggan->id }}&id_rumah={{ $item->rumah->id }}"
                                                    class="btn btn-primary">
                                                    Lakukan Pembayaran Uang Muka
                                                </a>
