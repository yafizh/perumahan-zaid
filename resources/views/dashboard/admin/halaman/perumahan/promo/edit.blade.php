                ...
                <form action="/admin/promo/{{ $promo->id }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" id="tanggal_mulai" name="tanggal_mulai" required
                            autocomplete="off" value="{{ old('tanggal_mulai', $promo->tanggal_mulai) }}">
                    </div>
                    <div class="mb-3">
                        <label for="tanggal_selesai" class="form-label">Tanggal Selesai</label>
                        <input type="date" class="form-control" id="tanggal_selesai" name="tanggal_selesai" required
                            autocomplete="off" value="{{ old('tanggal_selesai', $promo->tanggal_selesai) }}">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="pengurangan_harga" name="pengurangan_harga" required
                            autocomplete="off"
                            value="{{ number_format(old('pengurangan_harga', $promo->pengurangan_harga), 0, ',', '.') }}">
                    </div>
