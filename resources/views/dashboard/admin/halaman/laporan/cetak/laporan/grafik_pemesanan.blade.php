...
@section('content')
    ...
    {!! $chart->script() !!}
    <p class="px-3">
        Grafik pemesanan menggambarkan jumlah pemesanan selama bulan
        <br>
        <strong>{{ implode(', ', $labels) }}</strong>.
        <br>
        Pada bulan {{ $labels[0] }}, tercatat terjadi {{ $dataset[0] }} transaksi pemesanan.
        <br>
        Pada bulan {{ $labels[1] }}, tercatat terjadi {{ $dataset[1] }} transaksi pemesanan.
        <br>
        Pada bulan {{ $labels[2] }}, tercatat terjadi {{ $dataset[2] }} transaksi pemesanan.
    </p>
@endsection
